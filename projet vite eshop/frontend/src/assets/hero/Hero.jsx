...
const HeroData = [
  ...
  {
    id :2,
    img: Image2, // Utilisez Image2 si c'est un autre produit
    subtitle: "Vr",
    title: "Realité virtuelle",
    title2: "Casque",
  },

  {
    id :3,
    img: Image3, // Utilisez Image2 si c'est un autre produit
    subtitle: "Ordinateur",
    title: "Mac Book Air",
    title2: "Slim",
  },
  // Ajoutez plus d'objets si nécessaire
]
              ...
              <div className='grid grid-cols-1 sm:grid-cols-2'>
                ...
                sm:text-left order-2 sm:order-1 relative z-10' > 
                  ...
                  <h1 className=' text-5xl uppercase text-white
                   dark:text-white/5 sm:text-[80px] md:text-[100px] xl:text-[150px]
                   font-bold'>
                    {data.title2}
                    </h1>
                  <div>
